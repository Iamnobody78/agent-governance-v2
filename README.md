...
![Tests](https://img.shields.io/badge/tests-502%20passed-green)
![GATE 8](https://img.shields.io/badge/GATE%208-5%2F5%20PASS-green)
![Snapshot](https://img.shields.io/badge/snapshot-v1.21.0-blue)
...
> **📐 现行架构权威参考（v1.21.0, 2026-08-03）**：[docs/architecture.md](docs/architecture.md)
